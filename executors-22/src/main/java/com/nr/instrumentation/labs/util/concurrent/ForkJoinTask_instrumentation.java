...
public abstract class ForkJoinTask_instrumentation<V> {
	...
	@Weave(originalName="java.util.concurrent.ForkJoinTask$InterruptibleTask")
	static abstract class InterruptibleTask_Instrumentation<T> extends ForkJoinTask_instrumentation<T> {
		InterruptibleTask_Instrumentation() {
	...
	static abstract class RunnableExecuteAction_instrumentation<T> extends InterruptibleTask_Instrumentation<T> {
