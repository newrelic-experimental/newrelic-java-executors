...
import com.nr.instrumentation.labs.executors.NRBiConsumer;
import com.nr.instrumentation.labs.executors.NRBiFunctionWrapper;
import com.nr.instrumentation.labs.executors.NRConsumerWrapper;
import com.nr.instrumentation.labs.executors.NRErrorBiFunctionWrapper;
import com.nr.instrumentation.labs.executors.NRErrorFunctionWrapper;
import com.nr.instrumentation.labs.executors.NRFunctionWrapper;
import com.nr.instrumentation.labs.executors.NRRunnable;
import com.nr.instrumentation.labs.executors.NRSupplier;
import com.nr.instrumentation.labs.executors.TokenAndRefCount;
...
public abstract class CompletableFuture_instrumentation<T> implements CompletionStage<T> {
	...
	private CompletableFuture_instrumentation(Object o) {
	}
	...
	boolean uniExceptionally(CompletableFuture_instrumentation<T> a, Function<? super Throwable, ? extends T> f, UniExceptionally_instrumentation<T> c) {
